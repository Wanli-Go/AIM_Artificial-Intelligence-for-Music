...
class RecentlyPlayedMusicService{
  ...
  Future<List<Music>> getMusicListBySheet(String userId, String musicSheetId) async {
    // 定义一个url，替换你的后端地址和端口
  ...
  // 定义一个函数，接收当前页和每页大小作为参数，返回一个Future<List<MusicSheet>>
  Future<List<Music>> getLike(String userId, int currentPage,int pageSize) async {
    // 定义一个url，替换你的后端地址和端口
